...
const MOCK_DOCTORS_SEED = [
  ...
  },
  {
    ...
    satisfaction: 0,
    nextAvailable: "OCT 18",
    fee: 1000,
    image: null,
    bio: "Physician committed to comprehensive patient care and preventive medicine."
  }
];
...
async function main() {
  ...
  // Review distribution across different patients with unique clinical feedback
  const sampleReviews = [
  ...
  console.log("Seeding patient prescriptions and medications...");
    ...
    data: [
      {
        ...
        name: "Atorvastatin",
        dosage: "20 mg",
        instruction: "1 tablet after breakfast for cholesterol and cardiovascular support",
        timeSlot: "Morning",
      ...
      },
      {
        ...
        name: "Vitamin D3",
        dosage: "60,000 IU",
        instruction: "1 softgel post-lunch for bone and immune health",
        timeSlot: "Afternoon",
  ...
  console.log("  ✓ Seeded active prescriptions for demo patient");

  console.log("Seeding clinical notes and vitals...");
  await prisma.clinicalRecord.create({
    data: {
      patientId: patientUser.patientProfile.id,
      doctorId: createdDoctors[0].doctorProfile.id,
      appointmentId: appt1.id,
      diagnosis: "Mild Essential Hypertension & Preventive Vascular Health",
      treatmentPlan: "Continue prescribed Telmisartan 40mg at bedtime and Atorvastatin 20mg. Low-sodium Mediterranean diet and brisk walking recommended.",
      notes: "Patient is responding well to therapy. Cranial nerve examination unremarkable. Blood pressure optimal.",
  ...
  console.log("  ✓ Seeded clinical diagnosis and baseline vitals");

  console.log("Seeding initial doctor-patient consultation messages...");
  const docUser = createdDoctors[0]; // Dr. Aarav Mehta
    ...
    data: [
      {
        ...
        senderRole: "DOCTOR",
        content: "Hello Rahul, welcome to your MediBook consultation thread. Please review your recent lab reports before our appointment.",
        appointmentId: appt1.id,
      ...
      },
      {
        ...
        senderRole: "PATIENT",
        content: "Thank you Doctor! I've uploaded the latest CBC analysis and vitals to my records vault.",
        appointmentId: appt1.id,
      ...
      },
      {
        ...
        receiverId: patientUser.id,
        senderRole: "DOCTOR",
        content: "Excellent. I've noted your medical history and will prepare the personalized treatment plan.",
        appointmentId: appt1.id,
        createdAt: new Date(Date.now() - 3600000 * 2), // 2 hours ago
      },
    ],
  });
  console.log("  ✓ Seeded consultation chat thread");
