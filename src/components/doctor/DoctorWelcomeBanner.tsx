...
import { Sparkles, Calendar, ShieldCheck, Stethoscope } from "lucide-react";
        ...
        >
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[11px] font-bold px-2.5 py-0.5 rounded-full bg-white/20 text-white flex items-center gap-1">
                <ShieldCheck className="size-3" /> Licensed Medical Specialist
              </span>
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight text-white leading-tight">
              Good Day, {doctorName.startsWith("Dr.") ? doctorName : `Dr. ${doctorName}`}!
            </h1>
            <p className="mt-1 text-sm sm:text-base text-blue-100/90 font-medium">
              Have a productive {dayName}! You have{" "}
              <span className="font-bold underline decoration-blue-300 underline-offset-2">
                {upcomingCount} scheduled {upcomingCount === 1 ? "consultation" : "consultations"}
              </span>{" "}
              and {totalPatients} appointed {totalPatients === 1 ? "patient" : "patients"} under your care.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2.5 pt-1 flex-wrap">
            ...
            >
              ...
              <span>OPD Chamber 304 • Real-Time Prescription Sync Enabled</span>
            </motion.div>
